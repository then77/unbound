        ...
        <button
            ...
            className={cn(
                buttonVariants({
                    color: "ghost",
                    size: "sm",
                    className: "h-8 gap-2 [&_svg]:size-3.5",
                }),
                props.className,
            )}
        >
            <span className="relative inline-flex size-3.5">
                <Check
                    className={cn(
                        "size-3.5 opacity-100 scale-100 transition-[opacity,scale]",
                        !checked && "opacity-0 scale-50",
                    )}
                />
                <Copy
                    className={cn(
                        "absolute size-3.5 opacity-100 scale-100 transition-[opacity,scale]",
                        checked && "opacity-0 scale-50",
                    )}
                />
            </span>
            {props.children ?? t("Copy MD")}
        </button>
    );
}
        ...
        <Popover>
            <PopoverTrigger
                ...
                className={cn(
                    ...
                    "h-8 gap-2 data-[state=open]:bg-fd-accent data-[state=open]:text-fd-accent-foreground",
                    props.className,
                )}
            >
